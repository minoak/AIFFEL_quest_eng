...
**AIFFEL DLthon** · 2026.04.22 ~ 04.24 (3일) · **후처리 파이프라인 전체 솔로 설계·구현**
...
**역할 분담**: 팀 = Segmentation 모델 학습 · **나 = Segmentation 출력 이후의 전부** — 거리 추정, 위험도 판정, HUD 시각화까지 5-layer 후처리 파이프라인 솔로 담당.
